...
const IndexPage = () => {
  ...
  return (
    <Layout>
      ...
      <div className={globalStyles.sidePane}>
        <div className={globalStyles.profile}>
          <img src={sahebgiri} alt="Saheb Giri" height="100px" width="100px" />
          <h2>Saheb Giri</h2>
          <p>Student and Entreprenerd</p>
          <div className={globalStyles.stats}>
            <div className={globalStyles.statsItem}>
              <h2>{data.allMarkdownRemark.edges.length}</h2>
              <span>Posts</span>
            </div>
            <div className={globalStyles.statsItem}>
              <h2>245</h2>
          ...
          <div className={globalStyles.socialIcons}>
            <ul>
              <li>
                <a href="https://facebook.com/iamsahebgiri" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <a href="https://instagram.com/iamsahebgiri" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <a href="https://github.com/iamsahebgiri" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <a href="https://twitter.com/iamsahebgiri" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <a href="https://youtube.com/hivartex" target="_blank" rel="noopener noreferrer">
